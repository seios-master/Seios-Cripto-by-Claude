/* =====================================================================
   ...
   =====================================================================
   Todo teste aqui DEVE falhar contra a v90. Se algum passa nas duas
   versões, ele não está testando a correção — está testando outra coisa.

   Uso:  node harness-v91.js index.html
   ===================================================================== */
...
/* ---- extrator: pega a função pelo nome, casando chaves ---------------- */
...
ctx.registrarObservacao = function(){};   // IndexedDB não roda aqui
ctx.esc = s => String(s);
...
// GATILHO_FONTE precisa enxergar o mesmo escopo — reexporta as leitoras
...
/* =====================================================================
   BLOCO A — a falha de fonte retira o voto
   ===================================================================== */
...
t("A", "A COBERTURA CAI quando a fonte cai — a trava volta a poder disparar", ()=>{
  ctx.S = estadoBase();
...
/* =====================================================================
   BLOCO C — o backup não pode apagar a correção
   ===================================================================== */
