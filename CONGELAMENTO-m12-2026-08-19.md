...
## `m12-2026-08-19` · build `2026-08-19.118-textos-m12` · 19 de agosto de 2026

> **Este documento foi reescrito em 19/08.** O `m11` foi congelado em 18/08 e
> descongelado no mesmo dia, uma única vez, para corrigir premissas que ~110
> medições refutaram — com a série ainda em 4 janelas, o momento mais barato que
> existiria. **Foi a última mudança de modelo.** A partir daqui, "os dados
> sugerem" deixa de ser argumento aceitável: ver o anexo
> `RESULTADOS-LABORATORIO-2026-08-19.md`, onde ~110 testes não aprovaram nada.
...
| | |
|---|---|
| Modelo | `m12-2026-08-19` |
| Build | `2026-08-19.118-textos-m12` |
| Bateria | 416 testes · 0 falhas |
| Indicadores votantes | 33, em 9 motores |
| Sensores (registram, não votam) | 6 |
| Série acumulada | zerada pelo bump — recomeça do zero em 19/08 |
...
- **Os pesos dos nove motores.** **Ativos Globais 21%** · Macro **15%** ·
  Institucional 15% · On-chain 15% · Derivativos 15% · Sentimento 5% ·
  Geopolítico 5% · Eventos 5% · Técnico 4%.
- **Quem vota e quem não vota.** Os **seis** sensores continuam sensores:
  `bookImbalance`, `ouro`, `euro`, `longShort`, `takerRatio`, **`momentum`**.
...
**O que aconteceu em 19/08, e por que NÃO abre precedente:** o m11 foi reaberto
para corrigir três coisas que ~110 medições estabeleceram — um peso atribuído por
uma premissa refutada (Macro 28% para "o BTC responde a liquidez"), um indicador
votando com direção não verificada (momentum), e um patamar de decisão
inatingível por construção (+40). A justificativa foi **estrutural**, o custo era
**4 janelas**, e está registrado que a primeira dessas mudanças é **informada por
dado** — não é o caso limpo do euro. Repetir isso com 300 janelas acumuladas seria
outro cálculo, e a resposta seria não.
...
*Congelado em 19/08/2026 · `m12-2026-08-19` · `2026-08-19.118-textos-m12` ·
416 testes · 0 falhas · série em 0 de 777*
